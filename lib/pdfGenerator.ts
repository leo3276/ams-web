    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          ...
          <div>Page 1 of 1 · Generated by AMS Software</div>
        </div>
      </body>
    </html>
  `;
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">IFRS for SMEs / GAAP Compliant · Generated by AMS Software</div>
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">Audit Certified Statement · Generated by AMS Software</div>
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">Perpetual Stock Schedule · Generated by AMS Software</div>
          <div>Page 1 of 1</div>
        </div>
      </body>
    </html>
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">General Ledger Audit Stream · Generated by AMS Software</div>
          <div>Date: ${new Date().toLocaleDateString()}</div>
        </div>
      </body>
    </html>
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">Consolidated Executive Brief · Generated by AMS Software</div>
          <div>Date: ${new Date().toLocaleDateString()}</div>
        </div>
      </body>
    </html>
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">Accounts Payable &amp; Creditors Debt Book · Generated by AMS Software</div>
          <div>Date: ${new Date().toLocaleDateString()}</div>
        </div>
      </body>
    </html>
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">Trade Debtors &amp; Receivables Schedule · Generated by AMS Software</div>
          <div>Date: ${new Date().toLocaleDateString()}</div>
        </div>
      </body>
    </html>
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">Customer Refunds &amp; Trade-In Register · Generated by AMS Software</div>
          <div>Date: ${new Date().toLocaleDateString()}</div>
        </div>
      </body>
    </html>
  ...
  const html = `
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          <div class="footer-left">Immutable Compliance Audit Log · Generated by AMS Software</div>
          <div>Date: ${new Date().toLocaleDateString()}</div>
        </div>
      </body>
    </html>
